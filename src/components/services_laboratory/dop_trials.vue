                ...
                Trials:[
                    {
                        ...
                        trials_description: 'В результате проведения <b> дополнительных испытаний </b> подтверждается соответствие иделия требованиям нормативной документации (ГОСТ, ОСТ и тд.) При комплектовании высоконадежной аппаратуры, рекомендуется проводить проверку 100% изделий ЭКБ и КИ (а не только образцов), что гарантирует их дальнейшую работу в заданных условиях.',
                    }
                ],
                Stages_trials:[
                    {
