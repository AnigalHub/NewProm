        ...
        <b-container>
            ...
            <b-row >
                <b-col cols="3">
                    <video autoplay muted loop playsinline webkit-playingline width="100%" poster="video/video.png">
                        <source src="video/vhod.mp4" type="video/mp4" >
                    </video>
                </b-col>
                <b-col>
                    <p class="text descr">
                        <b>Входной контроль </b> — это ряд работ, проводимых в испытательной лаборатории ООО «Компании Промэлектронсервис» с целью выявления некачественной продукции или ее несоответствие заявленным требованиям.
                    </p>
                </b-col>
            </b-row>
            ...
            <b-row class="row_step">
                ...
                <b-col cols="5">
                    ...
                    >
                        <b-carousel-slide
                                img-src="./images/vhodnoi_control/1.jpg"
                        ></b-carousel-slide>
                        <b-carousel-slide
                                img-src="./images/vhodnoi_control/2.jpg"
                        ></b-carousel-slide>
                        <b-carousel-slide
                                img-src="./images/vhodnoi_control/3.jpg"
                        ></b-carousel-slide>
                        <b-carousel-slide
                                img-src="./images/vhodnoi_control/4.jpg"
                        ></b-carousel-slide>
                    </b-carousel>
                </b-col>
            </b-row>
