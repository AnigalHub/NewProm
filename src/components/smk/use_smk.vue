<template>
    <div id="use_smk">
        <b-container>
            <h2>Применение системы менеджмента качества</h2>
            <p class="text">
...
<style scoped lang="scss">
    ...
    .circle.fill {
        padding: 5%;
        background: rgba(36, 116, 190, 0.6);
